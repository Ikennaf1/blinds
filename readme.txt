=== Blinds Dark Mode ===
Contributors: ikennaf1
Tags: darkmode, dark-mode, dark mode, nightmode, night-mode, night mode
...
= Does it work for WordPress admin? =
...
1. A normal post using [ThemeGrill](https://themegrill.com/)'s [ColorNews](https://demo.themegrill.com/colornews/)
2. Blinds Dark mode activated
3. A demo [WooCommerce](https://woocommerce.com) Storefront
4. Hurray! Works with WooCommerce too!
5. Works with WooCommerce Products page too
6. Works at the admin dashboardincluding the log in page

== Installation ==

Upload the Blinds plugin to your blog, activate it.
